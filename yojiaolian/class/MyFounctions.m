...
+(UIImage*)getSubImage:(CGRect)rect souce:(UIImage*)img
{
...
{
    [redView setFrame:CGRectMake(PARENT_X(redView), PARENT_Y(redView), grayView.frame.size.width*(float)percent/100.0, PARENT_HEIGHT(redView))];
}
